...
Public Class MainMenu
    ...
    Private Sub BtnButter_Click(sender As Object, e As EventArgs) Handles btnButter1.Click
        ...
        SubmitButterButton(TempArray(1), TempArray(2), TempArray(3), TempArray(4), TempArray(5), TempArray(6), TempArray(7), TempArray(8))
    End Sub
    Function SubmitButterButton(Name As String, Brand As String, Weight As Decimal, Calories As Decimal, Proteins As Decimal, Carbs As Decimal, Sugar As Decimal, Fat As Decimal)
    ...
    Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles BtnDelete.Click
        ...
        End Try
    End Sub
    Private Sub Label12_Click(sender As Object, e As EventArgs) Handles LblFoodList.Click
    ...
    Private Function UpdateStatistc()
        ...
        If reader.HasRows Then
            ...
            End While
        Else
            TbxWeightCurrent.Text = "0"
        End If
        sqlcon.Close()

        'checks if Weight has been posted, if its more than 0, it will show as update, instead of submitting
        If IsNumeric(TbxWeightCurrent.Text) Then
            If TbxWeightCurrent.Text > 0 Then
                BtnSubtmitWeight.Text = "Update"
            Else
                BtnSubtmitWeight.Text = "Submit"
            End If
        End If
    ...
    Private Function UpdateGrid()
        ...
        Try
            ...
            Dim sqlcmd As New SqlCommand("SELECT Name, Brand, Weight, Calories, Protein, Carbohydrates, Sugar, Fat, Date, UID 
    ...
    Private Sub Button1_Click_2(sender As Object, e As EventArgs) Handles BtnCollectionSubmit.Click
        ...
        Dim intCounterStart As Integer
        Dim intCounter As Integer
        If CbPlus1.Checked = True Then
            intCounterStart = 1
        Else
            intCounterStart = 0
        End If
        If IsNumeric(TbxCollectionWeight.Text) And TbxCollectionName.Text.Length >= 1 Then
            If CbxSplitAmount.Text < 2 Then
                ...
                End If
            Else
                For intCounter = intCounterStart To CbxSplitAmount.Text  ' values gets divide by the amount of days (Minus today) and the amount of records get inserted over x days
                    InsertFoodHistory(TbxCollectionName.Text, TbxCollectionWeight.Text / CbxSplitAmount.Text, LblCurrentCollectionCurrentCal.Text / CbxSplitAmount.Text, LblCurrentCollectionCurrentProt.Text / CbxSplitAmount.Text, LblCurrentCollectionCurrentCarb.Text / CbxSplitAmount.Text, LblCurrentCollectionCurrentSug.Text / CbxSplitAmount.Text, LblCurrentCollectionCurrentFat.Text / CbxSplitAmount.Text, Today.AddDays(intCounter))
                Next
    ...
    Private Sub TbxWeightCurrent_TextChanged(sender As Object, e As EventArgs) Handles TbxWeightCurrent.TextChanged
        TbxWeightCurrent.SelectAll()
    End Sub

    Private Sub LblRecipeList_Click(sender As Object, e As EventArgs) Handles LblRecipeList.Click
